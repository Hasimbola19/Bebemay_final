defmodule Bebemayotte.CustomersTest do
  ...
  describe "customers" do
    ...
    @valid_attrs %{email: "some email", name: "some name", stripe_customer: "some stripe_customer"}
    @update_attrs %{email: "some updated email", name: "some updated name", stripe_customer: "some updated stripe_customer"}
    @invalid_attrs %{email: nil, name: nil, stripe_customer: nil}
    ...
    test "create_customer/1 with valid data creates a customer" do
      ...
      assert customer.stripe_customer == "some stripe_customer"
    end
    ...
    test "update_customer/2 with valid data updates the customer" do
      ...
      assert customer.stripe_customer == "some updated stripe_customer"
    end
